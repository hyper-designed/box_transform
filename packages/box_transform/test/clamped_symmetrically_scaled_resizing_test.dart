...
void main() {
  test('Clamped symmetrically scaled resizing with bottom-right handle', () {
    var result = BoxTransformer.resize(
      ...
      initialRect: Box.fromLTWH(268.45, 413.00, 283.19, 213.11),
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(163.71, 334.18, 492.67, 370.74),
      handle: HandlePosition.bottomRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(300.77, 437.32, 218.55, 164.46),
      handle: HandlePosition.bottomRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(267.29, 412.13, 285.50, 214.85),
      handle: HandlePosition.bottomRight,
    ...
    result = BoxTransformer.resize(
      ...
      initialRect: Box.fromLTWH(248.90, 398.29, 322.28, 242.52),
  ...
  test('Clamped symmetrically scaled resizing with top-left handle', () {
    var result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(259.73, 406.45, 300.62, 226.22),
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(310.76, 444.85, 198.55, 149.42),
      handle: HandlePosition.topLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.diagonal,
      initialRect: Box.fromLTWH(313.66, 447.03, 192.76, 145.06),
      handle: HandlePosition.bottomRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.vertical,
      initialRect: Box.fromLTWH(291.21, 430.13, 237.67, 178.85),
      handle: HandlePosition.bottomLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.horizontal,
      initialRect: Box.fromLTWH(292.28, 430.94, 235.53, 177.24),
      handle: HandlePosition.topRight,
  ...
  test('Clamped symmetrically scaled resizing with top-right handle', () {
    var result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(260.65, 407.13, 298.79, 224.84),
      handle: HandlePosition.topRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(329.97, 459.30, 160.14, 120.51),
      handle: HandlePosition.topRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.diagonal,
      initialRect: Box.fromLTWH(306.83, 441.88, 206.43, 155.34),
      handle: HandlePosition.bottomLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.horizontal,
      initialRect: Box.fromLTWH(283.45, 424.30, 253.18, 190.52),
      handle: HandlePosition.topLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.vertical,
      initialRect: Box.fromLTWH(255.09, 402.95, 309.91, 233.21),
      handle: HandlePosition.bottomRight,
  ...
  test('Clamped symmetrically scaled resizing with bottom-left handle', () {
    var result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(264.98, 410.39, 290.13, 218.33),
      handle: HandlePosition.bottomLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(288.99, 428.46, 242.10, 182.19),
      handle: HandlePosition.bottomLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.horizontal,
      initialRect: Box.fromLTWH(287.78, 427.56, 244.51, 184.00),
      handle: HandlePosition.bottomRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.diagonal,
      initialRect: Box.fromLTWH(279.54, 421.35, 261.00, 196.40),
      handle: HandlePosition.topRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.vertical,
      initialRect: Box.fromLTWH(268.07, 412.72, 283.95, 213.68),
      handle: HandlePosition.topLeft,
  ...
  test('Clamped symmetrically scaled resizing with right handle', () {
    var result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(291.02, 429.99, 238.05, 179.13),
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(315.40, 448.34, 189.28, 142.44),
      handle: HandlePosition.right,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.horizontal,
      initialRect: Box.fromLTWH(270.48, 414.53, 279.13, 210.05),
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(281.55, 422.87, 256.97, 193.38),
      handle: HandlePosition.right,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.vertical,
      initialRect: Box.fromLTWH(243.78, 394.44, 332.52, 250.23),
      handle: HandlePosition.right,
  ...
  test('Clamped symmetrically scaled resizing with left handle', () {
    var result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(237.52, 389.73, 345.04, 259.65),
      handle: HandlePosition.left,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(308.57, 443.20, 202.93, 152.71),
      handle: HandlePosition.left,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.horizontal,
      initialRect: Box.fromLTWH(277.06, 419.48, 265.96, 200.14),
      handle: HandlePosition.right,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(280.38, 421.98, 259.32, 195.15),
      handle: HandlePosition.left,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.vertical,
      initialRect: Box.fromLTWH(273.34, 416.69, 273.39, 205.74),
      handle: HandlePosition.left,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(212.17, 370.65, 395.74, 297.80),
      handle: HandlePosition.left,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.diagonal,
      initialRect: Box.fromLTWH(230.26, 384.26, 359.57, 270.58),
      handle: HandlePosition.right,
  ...
  test('Clamped symmetrically scaled resizing with bottom handle', () {
    var result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(131.77, 394.39, 326.97, 246.05),
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(66.74, 345.46, 457.02, 343.92),
      handle: HandlePosition.bottom,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(220.68, 461.30, 149.15, 112.24),
      handle: HandlePosition.bottom,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.vertical,
      initialRect: Box.fromLTWH(174.42, 426.49, 241.66, 181.86),
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(151.10, 408.94, 288.30, 216.95),
      handle: HandlePosition.bottom,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.horizontal,
      initialRect: Box.fromLTWH(109.96, 377.98, 370.59, 278.88),
      handle: HandlePosition.bottom,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.vertical,
      initialRect: Box.fromLTWH(150.06, 408.15, 290.39, 218.53),
      handle: HandlePosition.top,
  ...
  test('Clamped symmetrically scaled resizing with top handle', () {
    var result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(146.96, 405.82, 296.58, 223.18),
      handle: HandlePosition.top,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(184.16, 433.82, 222.18, 167.20),
      handle: HandlePosition.top,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.vertical,
      initialRect: Box.fromLTWH(179.14, 430.04, 232.21, 174.75),
      handle: HandlePosition.bottom,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(158.65, 414.62, 273.21, 205.60),
      handle: HandlePosition.top,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.horizontal,
      initialRect: Box.fromLTWH(107.33, 376.00, 375.85, 282.83),
      handle: HandlePosition.top,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.diagonal,
      initialRect: Box.fromLTWH(145.58, 404.78, 299.35, 225.27),
      handle: HandlePosition.bottom,
  ...
  test('Extra tests for scaledSymmetricClampingBox', () {
    var result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(455.26, 505.17, 264.08, 320.10),
      handle: HandlePosition.bottomRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(410.68, 451.14, 353.23, 428.15),
      handle: HandlePosition.bottomRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.diagonal,
      initialRect: Box.fromLTWH(441.07, 487.97, 292.46, 354.50),
      handle: HandlePosition.topLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(361.01, 91.52, 294.24, 356.65),
      handle: HandlePosition.bottomRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(317.82, 39.17, 380.62, 461.35),
      handle: HandlePosition.bottomRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetricScale,
      initialFlip: Flip.diagonal,
      initialRect: Box.fromLTWH(358.88, 88.94, 298.50, 361.82),
      handle: HandlePosition.topLeft,
