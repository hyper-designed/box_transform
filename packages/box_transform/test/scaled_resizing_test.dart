...
void main() {
  test('Scaled resizing with bottom right handle', () {
    var result = BoxTransformer.resize(
      ...
      initialBox: Box.fromLTWH(201.37, 379.05, 321.96, 191.97),
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(201.37, 379.05, 463.32, 276.25),
      handle: HandlePosition.bottomRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(201.37, 379.05, 205.73, 122.67),
      handle: HandlePosition.bottomRight,
    ...
    result = BoxTransformer.resize(
      ...
      initialBox: Box.fromLTWH(52.05, 290.01, 149.32, 89.03),
    ...
    result = BoxTransformer.resize(
      ...
      initialBox: Box.fromLTWH(201.37, 98.10, 471.19, 280.94),
    ...
    result = BoxTransformer.resize(
      ...
      initialBox: Box.fromLTWH(13.34, 379.05, 188.03, 112.11),
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(201.37, 379.05, 272.65, 162.57),
      handle: HandlePosition.bottomRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(201.37, 379.05, 400.00, 238.50),
      handle: HandlePosition.bottomRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.vertical,
      initialBox: Box.fromLTWH(201.37, 309.16, 117.21, 69.89),
      handle: HandlePosition.topRight,
  ...
  test('Scaled resizing with top-left handle', () {
    var result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(244.96, 365.46, 248.19, 192.53),
      handle: HandlePosition.topLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(72.75, 231.87, 420.40, 326.12),
      handle: HandlePosition.topLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(361.99, 456.25, 131.15, 101.74),
      handle: HandlePosition.topLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.diagonal,
      initialBox: Box.fromLTWH(493.14, 558.00, 115.67, 89.73),
      handle: HandlePosition.bottomRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.diagonal,
      initialBox: Box.fromLTWH(493.14, 558.00, 198.26, 153.80),
      handle: HandlePosition.bottomRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.vertical,
      initialBox: Box.fromLTWH(135.44, 558.00, 357.71, 277.49),
      handle: HandlePosition.bottomLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.vertical,
      initialBox: Box.fromLTWH(394.87, 558.00, 98.27, 76.23),
      handle: HandlePosition.bottomLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.horizontal,
      initialBox: Box.fromLTWH(493.14, 450.33, 138.79, 107.67),
      handle: HandlePosition.topRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.horizontal,
      initialBox: Box.fromLTWH(493.14, 389.87, 216.72, 168.13),
      handle: HandlePosition.topRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(111.86, 262.22, 381.28, 295.78),
      handle: HandlePosition.topLeft,
  ...
  test('Scaled resizing with top-right handle', () {
    var result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(253.43, 372.04, 239.71, 185.95),
      handle: HandlePosition.topRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(253.43, 458.16, 128.70, 99.84),
      handle: HandlePosition.topRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(253.43, 269.61, 371.75, 288.39),
      handle: HandlePosition.topRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.horizontal,
      initialBox: Box.fromLTWH(150.67, 478.27, 102.77, 79.72),
      handle: HandlePosition.topLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.horizontal,
      initialBox: Box.fromLTWH(19.49, 376.51, 233.95, 181.48),
      handle: HandlePosition.topLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.diagonal,
      initialBox: Box.fromLTWH(23.17, 558.00, 230.26, 178.63),
      handle: HandlePosition.bottomLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.diagonal,
      initialBox: Box.fromLTWH(159.78, 558.00, 93.66, 72.66),
      handle: HandlePosition.bottomLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.vertical,
      initialBox: Box.fromLTWH(253.43, 558.00, 399.13, 309.63),
      handle: HandlePosition.bottomRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.vertical,
      initialBox: Box.fromLTWH(253.43, 558.00, 186.67, 144.81),
      handle: HandlePosition.bottomRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(253.43, 457.45, 129.61, 100.55),
      handle: HandlePosition.topRight,
  ...
  test('Scaled resizing with bottom-left handle', () {
    var result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(253.43, 360.23, 254.93, 197.77),
      handle: HandlePosition.bottomLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(58.19, 360.23, 450.18, 349.23),
      handle: HandlePosition.bottomLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(294.20, 360.23, 214.17, 166.14),
      handle: HandlePosition.bottomLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.diagonal,
      initialBox: Box.fromLTWH(508.37, 281.02, 102.11, 79.21),
      handle: HandlePosition.topRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.diagonal,
      initialBox: Box.fromLTWH(508.37, 207.03, 197.48, 153.20),
      handle: HandlePosition.topRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.vertical,
      initialBox: Box.fromLTWH(338.85, 228.72, 169.52, 131.51),
      handle: HandlePosition.topLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.vertical,
      initialBox: Box.fromLTWH(90.03, 35.70, 418.34, 324.53),
      handle: HandlePosition.topLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.horizontal,
      initialBox: Box.fromLTWH(508.37, 360.23, 131.46, 101.98),
      handle: HandlePosition.bottomRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.horizontal,
      initialBox: Box.fromLTWH(508.37, 360.23, 184.67, 143.25),
      handle: HandlePosition.bottomRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(75.71, 360.23, 432.66, 335.64),
      handle: HandlePosition.bottomLeft,
  ...
  test('Scaled resizing with right handle', () {
    var result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(283.25, 360.23, 225.12, 174.64),
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(283.25, 293.45, 397.27, 308.19),
      handle: HandlePosition.right,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(283.25, 390.65, 146.68, 113.78),
      handle: HandlePosition.right,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.horizontal,
      initialBox: Box.fromLTWH(139.41, 391.76, 143.84, 111.58),
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.horizontal,
      initialBox: Box.fromLTWH(9.56, 341.39, 273.69, 212.32),
      handle: HandlePosition.left,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(283.25, 414.29, 85.74, 66.52),
      handle: HandlePosition.right,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(283.25, 323.41, 320.04, 248.27),
      handle: HandlePosition.right,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.vertical,
      initialBox: Box.fromLTWH(283.25, 332.34, 297.01, 230.41),
      handle: HandlePosition.right,
  ...
  test('Scaled resizing with left handle', () {
    var result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(283.25, 370.00, 199.94, 155.10),
      handle: HandlePosition.left,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(49.77, 279.43, 433.42, 336.23),
      handle: HandlePosition.left,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(277.97, 367.95, 205.22, 159.20),
      handle: HandlePosition.left,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.horizontal,
      initialBox: Box.fromLTWH(483.19, 411.32, 93.39, 72.45),
      handle: HandlePosition.right,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.horizontal,
      initialBox: Box.fromLTWH(483.19, 364.73, 213.52, 165.64),
      handle: HandlePosition.right,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(311.88, 381.10, 171.31, 132.90),
      handle: HandlePosition.left,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(77.78, 290.30, 405.41, 314.50),
      handle: HandlePosition.left,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.vertical,
      initialBox: Box.fromLTWH(196.64, 336.40, 286.55, 222.29),
      handle: HandlePosition.left,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(366.10, 402.13, 117.09, 90.83),
      handle: HandlePosition.left,
  ...
  test('Scaled resizing with top handle', () {
    var result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(231.37, 349.87, 251.82, 195.35),
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(308.04, 468.83, 98.48, 76.39),
      handle: HandlePosition.top,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(110.61, 162.51, 493.34, 382.71),
      handle: HandlePosition.top,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.vertical,
      initialBox: Box.fromLTWH(174.99, 545.22, 364.58, 282.82),
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.vertical,
      initialBox: Box.fromLTWH(282.94, 545.22, 148.69, 115.34),
      handle: HandlePosition.bottom,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(244.09, 369.61, 226.37, 175.61),
      handle: HandlePosition.top,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(250.04, 378.84, 214.47, 166.38),
      handle: HandlePosition.top,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.horizontal,
      initialBox: Box.fromLTWH(249.37, 377.80, 215.81, 167.42),
      handle: HandlePosition.top,
  ...
  test('Scaled resizing with bottom handle', () {
    var result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(164.09, 245.49, 386.38, 299.73),
      handle: HandlePosition.bottom,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(259.69, 245.49, 195.18, 151.41),
      handle: HandlePosition.bottom,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(64.25, 245.49, 586.07, 454.64),
      handle: HandlePosition.bottom,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.vertical,
      initialBox: Box.fromLTWH(271.50, 112.40, 171.56, 133.09),
      handle: HandlePosition.top,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.vertical,
      initialBox: Box.fromLTWH(214.75, 24.35, 285.07, 221.14),
      handle: HandlePosition.top,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(212.58, 245.49, 289.40, 224.50),
      handle: HandlePosition.bottom,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.horizontal,
      initialBox: Box.fromLTWH(160.17, 245.49, 394.23, 305.82),
      handle: HandlePosition.bottom,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.scale,
      initialFlip: Flip.none,
      initialBox: Box.fromLTWH(249.31, 245.49, 215.94, 167.52),
      handle: HandlePosition.bottom,
