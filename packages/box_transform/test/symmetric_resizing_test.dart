...
void main() {
  test('Symmetric resizing with bottom right handle', () {
    var result = BoxTransformer.resize(
      ...
      initialRect: Box.fromLTWH(275.20, 417.11, 174.30, 115.84),
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(156.89, 412.06, 410.91, 125.94),
      handle: HandlePosition.bottomRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(119.71, 297.92, 485.29, 354.22),
      handle: HandlePosition.bottomRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(302.32, 314.99, 120.07, 320.08),
      handle: HandlePosition.bottomRight,
    ...
    result = BoxTransformer.resize(
      ...
      initialRect: Box.fromLTWH(87.75, 333.52, 549.21, 283.02),
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.horizontal,
      initialRect: Box.fromLTWH(300.38, 354.18, 123.95, 241.71),
      handle: HandlePosition.bottomLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.horizontal,
      initialRect: Box.fromLTWH(291.08, 438.70, 142.54, 72.67),
      handle: HandlePosition.bottomLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(169.97, 403.01, 384.76, 144.04),
      handle: HandlePosition.bottomRight,
    ...
    result = BoxTransformer.resize(
      ...
      initialRect: Box.fromLTWH(165.39, 388.67, 393.92, 172.73),
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.vertical,
      initialRect: Box.fromLTWH(158.91, 200.16, 406.89, 549.74),
      handle: HandlePosition.topRight,
  ...
  test('Symmetric resizing with top-left handle', () {
    var result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(170.73, 368.86, 383.23, 212.35),
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(62.73, 400.98, 599.25, 148.10),
      handle: HandlePosition.topLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(297.15, 347.53, 130.40, 255.01),
      handle: HandlePosition.topLeft,
      initialLocalPosition: Vector2(11.37, 10.17),
      allowFlipping: true,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.horizontal,
      initialRect: Box.fromLTWH(182.96, 364.72, 358.77, 220.62),
      handle: HandlePosition.topRight,
      initialLocalPosition: Vector2(11.37, 10.17),
      allowFlipping: true,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.horizontal,
      initialRect: Box.fromLTWH(42.66, 340.45, 639.38, 269.17),
      handle: HandlePosition.topRight,
      initialLocalPosition: Vector2(11.37, 10.17),
      allowFlipping: true,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(202.94, 394.43, 318.83, 161.20),
      handle: HandlePosition.topLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.vertical,
      initialRect: Box.fromLTWH(197.23, 300.34, 330.25, 349.38),
      handle: HandlePosition.bottomLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(201.58, 197.39, 321.55, 555.29),
      handle: HandlePosition.topLeft,
    ...
    result = BoxTransformer.resize(
      ...
      initialRect: Box.fromLTWH(175.10, 316.82, 374.51, 316.41),
      handle: HandlePosition.bottomRight,
      initialLocalPosition: Vector2(8.94, 10.86),
      allowFlipping: true,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.diagonal,
      initialRect: Box.fromLTWH(301.80, 314.89, 121.11, 320.27),
      handle: HandlePosition.bottomRight,
  ...
  test('Symmetric resizing with top-right handle', () {
    var result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(214.25, 369.91, 296.20, 210.24),
      handle: HandlePosition.topRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(73.16, 299.25, 578.39, 351.57),
      handle: HandlePosition.topRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(149.78, 421.57, 425.14, 106.92),
      handle: HandlePosition.topRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.horizontal,
      initialRect: Box.fromLTWH(228.78, 420.02, 267.15, 110.02),
      handle: HandlePosition.topLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.horizontal,
      initialRect: Box.fromLTWH(106.50, 299.26, 511.71, 351.55),
      handle: HandlePosition.topLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.diagonal,
      initialRect: Box.fromLTWH(119.96, 408.21, 484.79, 133.63),
      handle: HandlePosition.bottomLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.diagonal,
      initialRect: Box.fromLTWH(293.86, 279.29, 136.98, 391.48),
      handle: HandlePosition.bottomLeft,
      initialLocalPosition: Vector2(12.47, 12.81),
      allowFlipping: true,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.horizontal,
      initialRect: Box.fromLTWH(261.03, 391.54, 202.65, 166.98),
      handle: HandlePosition.topLeft,
      initialLocalPosition: Vector2(12.47, 12.81),
      allowFlipping: true,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.horizontal,
      initialRect: Box.fromLTWH(155.76, 320.41, 413.19, 309.25),
      handle: HandlePosition.topLeft,
      initialLocalPosition: Vector2(12.47, 12.81),
      allowFlipping: true,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(118.90, 331.72, 486.90, 286.62),
      handle: HandlePosition.topRight,
  ...
  test('Symmetric resizing with bottom-left handle', () {
    var result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.horizontal,
      initialRect: Box.fromLTWH(232.73, 384.98, 259.23, 180.09),
      handle: HandlePosition.bottomLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.horizontal,
      initialRect: Box.fromLTWH(212.96, 436.68, 298.79, 76.71),
      handle: HandlePosition.bottomLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.horizontal,
      initialRect: Box.fromLTWH(254.91, 233.94, 214.89, 482.18),
      handle: HandlePosition.bottomLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(245.19, 263.61, 234.33, 422.85),
      handle: HandlePosition.bottomRight,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(140.87, 401.91, 442.96, 146.24),
      handle: HandlePosition.bottomRight,
      initialLocalPosition: Vector2(11.52, 7.25),
      allowFlipping: true,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.horizontal,
      initialRect: Box.fromLTWH(243.53, 402.03, 237.65, 146.01),
      handle: HandlePosition.bottomLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.diagonal,
      initialRect: Box.fromLTWH(156.46, 364.39, 411.77, 221.29),
      handle: HandlePosition.topLeft,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.diagonal,
      initialRect: Box.fromLTWH(260.01, 245.88, 204.68, 458.30),
      handle: HandlePosition.topLeft,
      initialLocalPosition: Vector2(11.99, 11.47),
      allowFlipping: true,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(201.50, 383.32, 321.70, 183.42),
      handle: HandlePosition.bottomRight,
      initialLocalPosition: Vector2(11.99, 11.47),
      allowFlipping: true,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.horizontal,
      initialRect: Box.fromLTWH(187.64, 355.39, 349.42, 239.27),
      handle: HandlePosition.bottomLeft,
  ...
  test('Symmetric resizing with right handle', () {
    var result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(244.74, 394.46, 235.22, 161.13),
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(108.26, 394.46, 508.18, 161.13),
      handle: HandlePosition.right,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(274.57, 394.46, 175.55, 161.13),
      handle: HandlePosition.right,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.horizontal,
      initialRect: Box.fromLTWH(75.39, 394.46, 573.91, 161.13),
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.horizontal,
      initialRect: Box.fromLTWH(274.38, 394.46, 175.95, 161.13),
      handle: HandlePosition.left,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.diagonal,
      initialRect: Box.fromLTWH(269.80, 394.46, 185.10, 161.13),
      handle: HandlePosition.left,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.vertical,
      initialRect: Box.fromLTWH(222.11, 394.46, 280.49, 161.13),
      handle: HandlePosition.right,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(108.21, 394.46, 508.28, 161.13),
      handle: HandlePosition.right,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.horizontal,
      initialRect: Box.fromLTWH(188.60, 394.46, 347.51, 161.13),
      handle: HandlePosition.left,
  ...
  test('Symmetric resizing with left handle', () {
    var result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(245.23, 394.46, 234.25, 161.13),
      handle: HandlePosition.left,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(64.24, 394.46, 596.22, 161.13),
      handle: HandlePosition.left,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(307.96, 394.46, 108.78, 161.13),
      handle: HandlePosition.left,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.horizontal,
      initialRect: Box.fromLTWH(294.71, 394.46, 135.28, 161.13),
      handle: HandlePosition.right,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.horizontal,
      initialRect: Box.fromLTWH(58.86, 394.46, 606.98, 161.13),
      handle: HandlePosition.right,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(279.18, 394.46, 166.34, 161.13),
      handle: HandlePosition.left,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(120.59, 394.46, 483.52, 161.13),
      handle: HandlePosition.left,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.diagonal,
      initialRect: Box.fromLTWH(219.66, 394.46, 285.38, 161.13),
      handle: HandlePosition.right,
  ...
  test('Symmetric resizing with bottom handle', () {
    var result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(201.37, 394.46, 321.96, 161.13),
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(201.37, 253.71, 321.96, 442.63),
      handle: HandlePosition.bottom,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.vertical,
      initialRect: Box.fromLTWH(201.37, 409.09, 321.96, 131.88),
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.vertical,
      initialRect: Box.fromLTWH(201.37, 268.21, 321.96, 413.65),
      handle: HandlePosition.top,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(201.37, 238.21, 321.96, 473.63),
      handle: HandlePosition.bottom,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.horizontal,
      initialRect: Box.fromLTWH(201.37, 391.39, 321.96, 167.29),
      handle: HandlePosition.bottom,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.vertical,
      initialRect: Box.fromLTWH(201.37, 332.73, 321.96, 284.60),
      handle: HandlePosition.top,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(201.37, 410.21, 321.96, 129.63),
      handle: HandlePosition.bottom,
  ...
  test('Symmetric resizing with top handle', () {
    var result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(201.37, 367.09, 321.96, 215.88),
      handle: HandlePosition.top,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(201.37, 138.80, 321.96, 672.45),
      handle: HandlePosition.top,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(201.37, 422.09, 321.96, 105.88),
      handle: HandlePosition.top,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.vertical,
      initialRect: Box.fromLTWH(201.37, 415.46, 321.96, 119.15),
      handle: HandlePosition.bottom,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.vertical,
      initialRect: Box.fromLTWH(201.37, 205.54, 321.96, 538.99),
      handle: HandlePosition.bottom,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(201.37, 392.21, 321.96, 165.65),
      handle: HandlePosition.top,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.none,
      initialRect: Box.fromLTWH(201.37, 206.95, 321.96, 536.17),
      handle: HandlePosition.top,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.horizontal,
      initialRect: Box.fromLTWH(201.37, 393.73, 321.96, 162.60),
      handle: HandlePosition.top,
    ...
    result = BoxTransformer.resize(
      resizeMode: ResizeMode.symmetric,
      initialFlip: Flip.vertical,
      initialRect: Box.fromLTWH(201.37, 359.52, 321.96, 231.02),
      handle: HandlePosition.bottom,
